 ...
 */
public class RefreshableViewWrapperFrameLayout extends FrameLayout {
    ...
    public RefreshableViewWrapperFrameLayout(Context context, AttributeSet attr) {
        super(context, attr);
    ...
    public RefreshableViewWrapperFrameLayout(Context context) {
        super(context);
